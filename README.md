...
```
# Output:
<img width="593" height="397" alt="image" src="https://github.com/user-attachments/assets/736c7029-a7d4-4024-b55f-51b0edfdffb1" />
...
```
# Output:
<img width="684" height="618" alt="image" src="https://github.com/user-attachments/assets/e82ba7cb-20f4-42ab-a1e8-8f58247122ce" />
...
```
# Output:
<img width="704" height="784" alt="image" src="https://github.com/user-attachments/assets/34b2073c-4604-4bd4-9b47-ebdcd08dcf88" />
...
```
# Output:
<img width="775" height="398" alt="image" src="https://github.com/user-attachments/assets/8b7ec6a1-cc51-4221-8ec2-1c9812616f0f" />
